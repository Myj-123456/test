...
/// </summary>
public class ReConnectManager : MonoSingleton<ReConnectManager>
{
    ...
    private void Update()
    {
        if (!isStartReConnect || !NetWorkManager.Instance.CheckIsNeedReConnect || !LoginModel.Instance.isGameInit) return;
    ...
    {
        Debug.Log("游戏服重试连接中，次数:" + reConnectTime);
        LoginController.Instance.ReConnect();
    }
}
