...
{
   private fun_Welfare.sign_view view;
   ...
   public SignView(fun_Welfare.sign_view ui)
    {
        view = ui;
        view.list.height = view.timeLab.y - view.day_num.y - 185;
    ...
    private void UpdateData()
    {
        ...
        view.day_num.text = Lang.GetValue("welfare_main_8") + "£º" + WelfareModel.Instance.signDay.ToString();
        var costs = GlobalModel.Instance.module_profileConfig.signDayCost;
        var index = WelfareModel.Instance.retroactiveDays >= costs.Count?costs.Count - 1: (int)WelfareModel.Instance.retroactiveDays;
        if(index > -1)
        {
    ...
    {
        var cell = item as fun_Welfare.sign_item;
    ...
    private void UpdateTime()
    {
        ...
        timer.prefixString = Lang.GetValue("lshop_ui_label_duration") + "£º";
        timer.Run();
    }

    private int GetEndTime()
    {
        var day = 30 - WelfareModel.Instance.currentSignDay;
