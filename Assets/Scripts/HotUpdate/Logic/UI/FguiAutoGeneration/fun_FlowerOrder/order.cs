...
namespace fun_FlowerOrder
{
    public partial class order : GComponent
    {
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            n348 = (GImage)GetChildAt(1);
            n293 = (GImage)GetChildAt(2);
            n279 = (GImage)GetChildAt(3);
            n282 = (GImage)GetChildAt(4);
            n291 = (GImage)GetChildAt(5);
            n284 = (GImage)GetChildAt(6);
            n294 = (GImage)GetChildAt(7);
            n285 = (GImage)GetChildAt(8);
            n301 = (GImage)GetChildAt(9);
            n283 = (GImage)GetChildAt(10);
            n297 = (GImage)GetChildAt(11);
            n308 = (GImage)GetChildAt(12);
            n311 = (GImage)GetChildAt(13);
            n305 = (GImage)GetChildAt(14);
            n314 = (GImage)GetChildAt(15);
            n313 = (GImage)GetChildAt(16);
            n298 = (GImage)GetChildAt(17);
            n287 = (GImage)GetChildAt(18);
            n286 = (GImage)GetChildAt(19);
            n288 = (GImage)GetChildAt(20);
            n289 = (GImage)GetChildAt(21);
            n290 = (GImage)GetChildAt(22);
            n292 = (GImage)GetChildAt(23);
            n295 = (GImage)GetChildAt(24);
            n296 = (GImage)GetChildAt(25);
            n302 = (GImage)GetChildAt(26);
            n303 = (GImage)GetChildAt(27);
            n304 = (GImage)GetChildAt(28);
            n306 = (GImage)GetChildAt(29);
            n307 = (GImage)GetChildAt(30);
            n310 = (GImage)GetChildAt(31);
            n309 = (GImage)GetChildAt(32);
            n299 = (GImage)GetChildAt(33);
            n300 = (GImage)GetChildAt(34);
            n354 = (GImage)GetChildAt(35);
            n251 = (GImage)GetChildAt(36);
            anim = (GLoader3D)GetChildAt(37);
            order_title_txt = (GTextField)GetChildAt(38);
            npc4 = (orderNpc)GetChildAt(39);
            npc3 = (orderNpc)GetChildAt(40);
            npc2 = (orderNpc)GetChildAt(41);
            npc6 = (orderNpc)GetChildAt(42);
            npc5 = (orderNpc)GetChildAt(43);
            npc1 = (orderNpc)GetChildAt(44);
            npc7 = (orderNpc)GetChildAt(45);
            n333 = (GImage)GetChildAt(46);
            doubleLab = (GTextField)GetChildAt(47);
            n335 = (GGroup)GetChildAt(48);
            n256 = (GImage)GetChildAt(49);
            need_list = (GList)GetChildAt(50);
            submit_btn = (GButton)GetChildAt(51);
            close_btn = (order_close)GetChildAt(52);
            doubledOrderRewardTxt = (GTextField)GetChildAt(53);
            timeTipLab = (GTextField)GetChildAt(54);
            timeLab = (GTextField)GetChildAt(55);
            timeShow = (GGroup)GetChildAt(56);
            progress_completed = (cd_progress)GetChildAt(57);
            ...
            exp_com = (reward_com)GetChildAt(64);
            n351 = (GImage)GetChildAt(65);
            ...
            n352 = (GTextField)GetChildAt(70);
            n355 = (GTextField)GetChildAt(71);
            n357 = (GImage)GetChildAt(72);
            n362 = (GImage)GetChildAt(73);
            n364 = (GImage)GetChildAt(74);
