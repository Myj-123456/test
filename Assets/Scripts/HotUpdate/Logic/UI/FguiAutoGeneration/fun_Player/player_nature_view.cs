...
{
    public partial class player_nature_view : GComponent
    {
        public GImage n2;
        public GLoader bg;
        public GImage n8;
        ...
        public const string URL = "ui://0svwl9suv5lj1yjp816";

        public static player_nature_view CreateInstance()
        {
            return (player_nature_view)UIPackage.CreateObject("fun_Player", "player_nature_view");
        }
