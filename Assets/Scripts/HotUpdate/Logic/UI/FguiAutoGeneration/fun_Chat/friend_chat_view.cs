...
namespace fun_Chat
{
    public partial class friend_chat_view : GComponent
    {
        ...
        public const string URL = "ui://z9jypfq8sh8h1yjp7x2";

        public static friend_chat_view CreateInstance()
        {
            return (friend_chat_view)UIPackage.CreateObject("fun_Chat", "friend_chat_view");
        }
