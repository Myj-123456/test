...
{
    public class fun_FriendsBinder
    {
        public static void BindAll()
        {
            ...
            UIObjectFactory.SetPackageItemExtension(newBestFriendLevelView.URL, typeof(newBestFriendLevelView));
            UIObjectFactory.SetPackageItemExtension(bestNullTip.URL, typeof(bestNullTip));
            UIObjectFactory.SetPackageItemExtension(blackListItem.URL, typeof(blackListItem));
            UIObjectFactory.SetPackageItemExtension(btn.URL, typeof(btn));
            UIObjectFactory.SetPackageItemExtension(newFriends_frendListItem.URL, typeof(newFriends_frendListItem));
            UIObjectFactory.SetPackageItemExtension(newFriendBlackView.URL, typeof(newFriendBlackView));
