...
{
    public class fun_WelfareBinder
    {
        public static void BindAll()
        {
            ...
            UIObjectFactory.SetPackageItemExtension(day_sign_view.URL, typeof(day_sign_view));
            ...
            UIObjectFactory.SetPackageItemExtension(box.URL, typeof(box));
