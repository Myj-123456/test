...
{
    public partial class sign_item : GComponent
    {
        ...
        public GImage n7;
        public GImage n6;
        public const string URL = "ui://awswhm01g0s0i";

        public static sign_item CreateInstance()
        {
            return (sign_item)UIPackage.CreateObject("fun_Welfare", "sign_item");
        }
