...
{
    public partial class guild_planting_item : GComponent
    {
        public GImage n1;
        ...
        public const string URL = "ui://qfpad3q0tewho";

        public static guild_planting_item CreateInstance()
        {
            return (guild_planting_item)UIPackage.CreateObject("fun_Guild_plant", "guild_planting_item");
        }
