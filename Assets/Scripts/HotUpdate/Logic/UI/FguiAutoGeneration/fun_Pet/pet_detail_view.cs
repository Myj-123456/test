...
namespace fun_Pet
{
    public partial class pet_detail_view : GComponent
    {
        ...
        public const string URL = "ui://o7kmyysdx92m2e";

        public static pet_detail_view CreateInstance()
        {
            return (pet_detail_view)UIPackage.CreateObject("fun_Pet", "pet_detail_view");
        }
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            attackLab = (GTextField)GetChildAt(11);
            defenLab = (GTextField)GetChildAt(12);
            hpLab = (GTextField)GetChildAt(13);
            comboLab = (GTextField)GetChildAt(14);
            skillLab = (GTextField)GetChildAt(15);
            skillDec = (GTextField)GetChildAt(16);
            haveLab = (GTextField)GetChildAt(17);
        }
    }
}