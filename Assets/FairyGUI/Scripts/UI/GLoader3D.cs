...
namespace FairyGUI
{
    ...
    public partial class GLoader3D : GObject, IAnimationGear, IColorGear
    {
        ...
        Action<string> _Complete;//动画播放完成事件回调


        public GLoader3D()
        {
            _url = string.Empty;
            _loaderUrl = string.Empty;
        ...
        public Action<string> Complete
        {
            set
            {
                ...
                _spineAnimation.AnimationState.Complete -= OnAnimationEventHandler;//每次先清空
                if (_Complete != null)
                {
                    _spineAnimation.AnimationState.Complete += OnAnimationEventHandler;
                }
            }
        }
        ...
        protected void ClearContent()
        {
            ...
            //_content.wrapTarget = null;//屏蔽掉，因为切换不同spine这里会导致闪
            _contentItem = null;
        }
