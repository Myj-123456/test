...
namespace FairyGUI
{
    ...
    public class UIObjectFactory
    {
        ...
        public delegate GLoader3D GLoaderCreator3D();
        ...
        static GLoaderCreator3D loaderCreator3D;
        ...
        {
            loaderCreator3D = () => { return (GLoader3D)Activator.CreateInstance(type); };
        }
        ...
        public static GObject NewObject(ObjectType type)
        {
            ...
            switch (type)
            {
                ...
                case ObjectType.Loader3D:
                    if (loaderCreator3D != null)
                        return loaderCreator3D();
                    else
