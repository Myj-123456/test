...
namespace ProtoBuf.Meta
{
    ...
    public abstract class TypeModel
    {
        ...
        public ProtoReader CreateProtoReader(Stream source, SerializationContext context)
        {
            return ProtoReader.Create(source, this, context,  ProtoReader.TO_EOF);
        } 
        /// <summary>
...
#else
        private static readonly System.Type ilist = typeof(IPbList);
#endif
