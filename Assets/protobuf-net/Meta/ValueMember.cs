...
namespace ProtoBuf.Meta
{
    ...
    /// </summary>
    public class ValueMember : IProtoSerializer
    {
            ...
            try
            {
                ...
                if (member != null)
                {
                    ...
                    else
                    {
                        ...
                        if (fld != null)
                        {
                            ser = new FieldDecorator(parentType, (FieldInfo)member, wireType, ser);
                        }
                        else
                        {
                            throw new InvalidOperationException();
            ...
            bool asReference, bool dynamicType, bool overwriteList, bool allowComplexTypes)
        {
            ...
            //if (type.IsGenericType && type == typeof(System.Collections.Generic.KeyValuePair<,>)) 
            //{
            //    defaultWireType = dataFormat == DataFormat.Group ? WireType.StartGroup : WireType.String;
            //    return new KeyValuePairDecorator(model, type);
            //}
        ...
        public Type ExpectedType => Serializer.ExpectedType;

        public bool RequiresOldValue => Serializer.RequiresOldValue;

        public bool ReturnsValue => Serializer.ReturnsValue;
