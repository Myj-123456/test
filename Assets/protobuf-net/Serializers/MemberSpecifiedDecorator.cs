...
namespace ProtoBuf.Serializers
{
    sealed class MemberSpecifiedDecorator : ProtoDecoratorBase
    {
        ...
        private readonly Func<object, bool> getAction;
            ...
            : base(tail)
        {
            ...
            this.getAction = getSpecified.CreateDelegate(typeof(Func<object, bool>)) as Func<object, bool>;
        }
#if !FEAT_IKVM
        public override void Write(object value, ProtoWriter dest)
        {
            if(getAction == null || getAction(value))
            {
